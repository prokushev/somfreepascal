...
set dccbase=%ProgramFiles(x86)%\Borland\Delphi 2.0
set vpcopt=/$P+ /$S- /$Speed- /$I- /$AlignCode- /$AlignData- /$Delphi+ /ucommon;%vpbase%\units.w32;%vpbase%\source\rtl;%vpbase%\source\w32 /i%vpbase%\source\rtl /l%vpbase%\lib.w32;%vpbase%\units.w32 /r%vpbase%\res.w32 /oout /m
...
"%dccbase%\bin\dcc32" -CC -B test.pas
test
goto end
